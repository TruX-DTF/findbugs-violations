...
/**
 * Learn features of code by deep learning with the CNN algorithm.
 * 
 ...
 *
 */
public class CNNFeatureLearner {
	
	private static Logger log = LoggerFactory.getLogger(CNNFeatureLearner.class);
	...
	public CNNFeatureLearner(File inputFile, int sizeOfVector, int sizeOfTokenVec, int batchSize, int sizeOfFeatureVector) {
	...
	public void extracteFeaturesWithCNN() throws FileNotFoundException, IOException, InterruptedException {
        ...
        //Save the model
        String modelFile = outputPath + "CNNoutput.zip";
