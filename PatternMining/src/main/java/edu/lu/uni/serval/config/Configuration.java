...
public class Configuration {
	...
	public static final String ALARMS = ROOT_PATH + "Alarms/";
	
	public static final int VECTOR_SIZE_OF_EMBEDED_TOKEN1 = 300; // tokens of edit scripts.
	public static final int VECTOR_SIZE_OF_EMBEDED_TOKEN2 = 300; // tokens of source code
