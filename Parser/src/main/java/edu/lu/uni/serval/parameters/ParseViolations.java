...
//			}
			...
			List<ViolationInstance> violations = readViolations(positionFilePath + fileName);
	...
	private List<ViolationInstance> readViolations(String file) {
		...
		try {
			while ((line = reader.readLine()) != null) {
				...
				ViolationInstance violation = new ViolationInstance(startLine, endLine, alarmType);
