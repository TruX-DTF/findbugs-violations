...
public class Configuration {
	...
	public static final long SECONDS_TO_WAIT = 3000L;
	
	public static final String ROOT_PATH = "../data/"; // The root path of all output data.
	...
	public static final String UNFIXED_VIOLATIONS_PATH = ROOT_PATH + "UnfixedViolations/";
