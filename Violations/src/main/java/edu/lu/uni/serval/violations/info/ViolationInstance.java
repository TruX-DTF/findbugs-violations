package edu.lu.uni.serval.violations.info;

public class ViolationInstance implements Comparable<ViolationInstance>, IViolation {
	...
	@Override
	public boolean equals(ViolationInstance bugInstance) {
...
//			return false;
	...
	@Override
	public int compareTo(ViolationInstance bugInstance) {
