package edu.lu.uni.serval.violations.xml.parser;
...
public class XmlParser implements IXmlParser {
	...
	private ViolationCollection bugCollection;

	public ViolationCollection getBugCollection() {
...
//					break;
		...
		ListSorter<ViolationInstance> als = new ListSorter<ViolationInstance>(bugInstances);
		bugInstances = als.sortAscending();

		this.bugCollection = new ViolationCollection(projectName, bugInstances);
	}
...
//					break;
	...
	@SuppressWarnings("unused")
	private boolean parseClassElement(List<?> classElements, ViolationInstance bugInstance) {
